...
# 1. Initialize global states used by the other pages
...
# 3. Draw the widgets and link them to our UI memory using the 'key' parameter
st.text_input("🔑 Enter your Groq API Key:", type="password", key="ui_api_key")
...
if st.button("🚀 Enter & Apply Settings", type="primary"):
    # Save the API Key to the global variable
    st.session_state.groq_api_key = st.session_state.ui_api_key
